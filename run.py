...
MENU = [
    ...
    },
    {
        ...
        "script": "a_baseline_replication.py",
        "cwd": "llm/a_pure_llm",
        "default_args": [],
        "note": "",
        "confirm_cost": True,
    ...
    {
        "label": "Run Kondisi C -- GraphRAG Framework (trust-weighted KG + hybrid retrieval)",
        "desc": "Sama seperti Kondisi A + hybrid retrieval (vector anchor -> graph traversal -> "
                "semantic expansion) atas Neo4j KG, dengan constraint sitasi [SO-<id>].",
        "script": "c_graphrag.py",
        "cwd": "llm/c_graphrag",
        "default_args": [],
        "note": "Prasyarat: KG sudah dibangun (01_data_cleaning/7_build_knowledge_graph.py) dan "
